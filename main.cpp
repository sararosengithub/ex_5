...
//small test
int main(){
    STDtest std(R"(C:\Users\sarar\CLionProjects\ex_5\input.txt)",R"(C:\\Users\\sarar\\CLionProjects\\ex_5\\output.txt)");
    CLI cli(&std);
    cli.start();
    std.close();
    check(R"(C:\\Users\\sarar\\CLionProjects\\ex_5\\output.txt)",R"(C:\\Users\\sarar\\CLionProjects\\ex_5\\expectedOutput.txt)");
    cout<<"done"<<endl;
    return 0;
